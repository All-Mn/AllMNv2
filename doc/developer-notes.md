...
ALLMN Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 20500.
...
However, in open source software such as ALLMN Core, where everyone uses
...
pay attention to for reviewers of ALLMN Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: ALLMN Core uses tinyformat, which is type safe. Leave them out to avoid confusion
