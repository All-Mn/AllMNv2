...
Only requiring some minor changes is allmn.cpp.
...
Changes to allmn.cpp
----------------------
allmn.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
