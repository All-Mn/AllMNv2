...
This mechanism has been integrated into Bitcore-Node-ALLMN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/AllMN/insight-api-allmn#web-socket-api](https://github.com/AllMN/insight-api-allmn#web-socket-api)
* API: [https://github.com/AllMN/insight-api-allmn#instantsend-transactions](https://github.com/AllMN/insight-api-allmn#instantsend-transactions)
...
By default, the ALLMN Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ALLMN Core daemon:
