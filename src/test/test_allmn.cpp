...
#define BOOST_TEST_MODULE ALLMN Test Suite

#include "test_allmn.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_allmn_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
