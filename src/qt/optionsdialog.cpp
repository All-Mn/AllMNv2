    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ALLMN-light"), QVariant("light"));
    ui->theme->addItem(QString("ALLMN-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("ALLMN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ALLMN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ALLMN-traditional"), QVariant("trad"));
