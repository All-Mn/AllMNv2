    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("ALLMN Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About ALLMN Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  allmn-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the ALLMN in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an innovative process to mix your inputs with the inputs of two other allmn, without having your coins ever leave your wallet. \
...
These denominations are 0.01 ALLMN, 0.1 ALLMN, 1 ALLMN and 10 ALLMN -- sort of like the paper money you use every day.</li> \
...
<li>When two other allmn send similar messages, indicating that they wish to mix the same denomination, a mixing session begins. \
...
For more info see <a href=\"https://AllMN.atlassian.net/wiki/display/DOC/PrivateSend\">https://AllMN.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("ALLMN Core is shutting down...") + "<br /><br />" +
