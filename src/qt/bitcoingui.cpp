    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("ALLMN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ALLMN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and allmn: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About ALLMN Core"), this);
    aboutAction->setStatusTip(tr("Show information about ALLMN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ALLMN Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ALLMN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ALLMN addresses"));
    ...
    openAction->setStatusTip(tr("Open a allmn: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ALLMN Core help message to get a list with possible ALLMN Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("ALLMN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ALLMN network", "", count));
    } else {
...
{
    QString strTitle = tr("ALLMN Core"); // default title
