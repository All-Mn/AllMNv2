...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all ALLMN related functionality
...
/*
    ...
    allow endless transaction that would bloat ALLMN and make it unusable. To
