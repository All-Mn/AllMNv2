 ...
 *   milestone-status-error allmn, option2, option3
 ...
 *
 *   // network
 *   CALLMNNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CALLMNNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: ALLMNNetwork
// //   -- signature requirements : Key1(User)
// class CALLMNNetworkVariable : public CGovernanceObject
// {
// private:
