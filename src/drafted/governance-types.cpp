...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "ALLMNNetwork") type = ALLMNNetwork;
    if(strType == "ALLMNNetworkVariable") type = ALLMNNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == ALLMNNetwork) s = "ALLMNNetwork";
    if(type == ALLMNNetworkVariable) s = "ALLMNNetworkVariable";
